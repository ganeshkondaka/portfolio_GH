...
export default function Home() {
  return (
    <div className="flex flex-col lg:flex-row min-h-screen w-screen bg-black">
      {/* Left Column */}
      <div className="text-white flex flex-col w-full lg:w-[430px] border-r border-zinc-700 lg:h-screen lg:sticky lg:top-0 px-6 py-12 bg-[#0D1117] order-1 lg:order-none">
        <div className="mb-8">
          <Left_top />
        </div>
        <div>
      ...
      <div className="p-4 lg:p-10 w-full flex flex-col lg:flex-row text-black dark:text-white order-2 lg:order-none">
        {/* Middle Column */}
